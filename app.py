...
if __name__ == '__main__':
    ...
    # FIXED: Don't load data on startup - this was causing the hang!
    # Data will be loaded on first request instead
    print("App ready! Data will be loaded on first request.")
